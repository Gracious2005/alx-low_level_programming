 ...
 *
 * Description: file is not an ELF - use exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int idx;
 ...
 * @e_ident: pointer to array that contains the ELF class.
 */
void print_data(unsigned char *e_ident)
{
	printf(" Data: ");
 ...
 * @e_ident: pointer to array that contains the ELF version.
 *
 */
void print_version(unsigned char *e_ident)
{
 ...
 * @e_ident: pointer to array that contains the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * close_elf - To Closean ELF file.
 * @elf:  file descriptor to the ELF file.
 *
 * Description: file cannot be closed - use exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
